...
- Composer package `indexnowkit/doctrine` (Doctrine ORM 2.19+/3, DBAL 3/4, on `indexnowkit/core`). In a Symfony application use `indexnowkit/symfony-bundle`, which wires this package.
