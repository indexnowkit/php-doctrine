...
- `IndexNowListener` builds its own `ObjectChangeHandler` (when given a resolver) with the extractor of the facade.

## [0.7.0] — 2026-09-06

### Changed

- Requires `indexnowkit/core ^0.9` (`Retry\ForbiddenCounter`, wave F); no code change in this package.
